    ...
    <div id="replaceTable">
            ...
            <div class="container">
                <div class="row header-row">
                    <div class="col-md-12 col-sm-12 col-xs-12 mt10 date-container ">
                        ...
                        <span style="color: #6874ad;" class="hidden-xs hidden-sm">{{ trans('vexe.ticket_today')}}<i
                                    class="pl5 pr5 text-gray left-arrow"></i>
                        </h1>
                        <div class="date-picker-nav hidden-md hidden-lg text-center">
                            <div class="btn-group btn-group-xs" role="group">
                                <button id="btPrevDate" type="button" class="btn btn-default"><img
                                            class="img-change-date" src="../images/vexe/icon-previous.png"></button>
                                <input type="button" id="span-current-date" value="" tabindex="1"
                                       class="btn btn-vxr current-date hasDatepicker">
                                <button id="btNextDate" type="button" class="btn btn-default"><img
                                            class="img-change-date" src="../images/vexe/icon-next.png"></button>
                            </div>
                        </div>
        ...
        <div id="dvSearchTicket" class="ticket-search-filter ">
            <div class="container desktop-route-search hidden-xs">
                <form id="searchForm" name="searchForm" class="form-inline" action="" method="POST"
                      enctype="multipart/form-data" autocomplete="off">
                    <div class="form-group place_viewlist">
                        <select class="selectpicker " id="departPlace" name="departPlace"
                                title="{{ trans('vexe.title_departPlace')}}" data-live-search="true" tabindex="-98">
                            <option disabled selected></option>
                            @if(count($place)!=0)
                                @foreach($place as $db_place)
                                    <option value="{{$db_place->name}}"
                                            data-tokens="{{$db_place->name}}">{{$db_place->name }} </option>
                                @endforeach
                            @endif
                            @if(count($place)==0)
                    ...
                    <div class="form-group place_viewlist">
                        <select class="selectpicker " id="destination" name="destination"
                                title="{{ trans('vexe.title_destination')}}" data-live-search="true" tabindex="-98">
                            <option disabled selected></option>
                            @if(count($place)!=0)
                                @foreach($place as $db_place)
                                    <option value="{{$db_place->name}}"
                    ...
                    <div class="form-group departDate-fg">
                        <input id="date_start" readonly="" name="date_start" type="text"
                               class="input-txt date calendar-search hasDatepicker"
                               placeholder="{{ trans('vexe.choose_time')}}" accesskey="1"
        ...
        <div id="dvSearchFilter" class="dvSearchFilter col-12 col-md-12 col-xs-12"
                ...
                <table class="table filter-table table-noborder mb0 ">
                    ...
                    <tr>
                        <td class="pl0 td-bus-operater-filter operater-filter ">
                            <a style="color: #6874ad;"
                               href="#" {{-- class="show_hide" --}}> {{ trans('vexe.car_cpm')}} </a>
                        </td>
                        <td class="hidden-xs ">
                            <span class="operater-filter "> <a style="color: #6874ad;"
                                                               href="#"{{--  class="show_hide" --}}>{{ trans('vexe.date_start')}}</a></span>
                        </td>
                        <td class="hidden-xs operater-filter ">
                            <a style="color: #6874ad;"
                               href="# " {{-- class="show_hide" --}}> {{ trans('vexe.time_start')}} </a>
                        </td>
                        <td class="hidden-xs operater-filter ">
                            <a style="color: #6874ad;"
                               href="#" {{-- " class="show_hide" --}}>{{ trans('vexe.departPlace')}} </a>
                        </td>
                        <td class="hidden-xs operater-filter ">
                            <a style="color: #6874ad;"
                               href="# " {{-- class="show_hide" --}}>{{ trans('vexe.destination')}}</a>
                        </td>
                        <td class="hidden-xs operater-filter ">
                            <a style="color: #6874ad;"
                               href="# " {{-- class="show_hide" --}}>{{ trans('vexe.comfortable')}}</a>
                        </td>
                        <td class="td-rate-filter giave-order ">
                            <a style="color: #6874ad;"
                               id="rateFilter " {{-- class="mr10 " --}}>{{ trans('vexe.notable')}}</a>
                        </td>
                        <td class="td-fare-filter giave-order ">
                            <a style="color: #6874ad;"
                               id="fareFilter " {{-- class="mr10 " --}}>{{ trans('vexe.ticket_fare')}}</a>
                        </td>
                    </tr>
                    </tbody>
                </table>
                ...
                <div id="main " class="container ">
                    ...
                    <table class="table result-list " id="hoang">
                        ...
                        <tr class="schedule-ticket result-item product_box col-12 col-md-12 col-xs-12 "
                            style="margin-top: 38px;     margin-bottom: -41px;">
                                ...
                                <div class="pull-left ml10 comp-name-container">
                                    <div class="hidden-lg hidden-md star-mobile hidden-sm">
                                        ...
                                        <div class="pull-left pull-left-mobi">
                                            ...
                                            <span class="totalHours">(34h)</span>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="busInfo hidden-sm hidden-xs">
                                        ...
                                        <li><a id="transfer-29-07-00" href="#"
                                               class="ml5 ticket-detail-tab-link text-route-link hover-orange-border hover-blue-text hidden hidden-xs hidden-sm">Trung
                                                chuyển</a></li>
                            ...
                            <td class=" col-4 col-md-4 col-xs-4 hidden-xs detail-route ">
                                <div class="col-12 ml10 text-center ">
                                    ...
                                    <div class="col-2 col-md-2 "><i class="pl5 pr5 text-gray3 left-arrow ">→<br></i>
                                    </div>
                                    <div class="col-5 col-md-5 ">
                                    ...
                                    <div class="col-5 col-md-5 hidden-xs hidden-sm mt25 ">
                                        <ul class="busInfo ">
                                            <li>
                                                <a style="color: #6874ad;"
                                                   class="mt0 depart-station ticket-detail-tab-link text-route-link hover-orange-border hover-blue-text "
                                                   href="# ">
                                                    {{ $list->itinerary['departPlace'] }}
                                                </a>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="col-5 col-md-5 hidden-xs hidden-sm mt25 ">
                                        <ul class="busInfo ">
                                            <li>
                                                <a style="color: #6874ad;"
                                                   class="mt0 destination-station ticket-detail-tab-link text-route-link hover-orange-border hover-blue-text "
                                                   href="# " onclick="return false; ">
                                                    {{ $list->itinerary['destination']}}
                                                    <div class="pop-vxr w300 destination-station-tip "
                                                         style="display: none; ">
                                                    </div>
                                                </a>
                                            </li>
                            ...
                            <td class="text-left  col-md-2 col-xs-2 text-center ">
                                ...
                                <div class="padd-top-1">
                                    ...
                                    <a href="# " data-tab="danhgia_{{$list->car_id}}" class="danhgia_link">
                                        @if ($list->rating->count == 0)
                                            <span class="BusQualityRating blue "> 0 <span></span> {{ trans('vexe.notable_carcpn')}}
                                                <i class="fa fa-sort-desc vt"></i></a>
                                    @else
                                        <span class="BusQualityRating blue ">{{round(($list->rating->overall+$list->rating->quality+$list->rating->intime+$list->rating->service)/($list->rating->count*4),2)}}
                                            /4</span> {{$list->rating->count}} <span></span> {{ trans('vexe.rate')}}<i
                                                class="fa fa-sort-desc vt"></i></a>
                                    @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul class="list-inline pull-left rate-star " data-value="1">
                                                            @if ($list->rating->count == 0)
                                                                <?php for ($i = 4; $i--; $i > 0) {?>
                                                                <li><i class="glyphicon glyphicon-star text-gray "></i>
                                                                </li>
                                                                <?php } ?>
                                                            @else
                                ...
                                <div>
                                    <a style="color: #6874ad;"
                                       class="comment-btn-popup text-route-link hover-blue-text comment-text rating"
                                       href="{{route('ticket.rate',['car_id'=>$list->car_id,'itinerary_id'=>$list->itinerary_id])}}">
                            ...
                            <td class="text-right pr0 col-md-3 col-xs-3 ">
                                ...
                                <h6 class="mt0 price ">
                                    {{ $list->itinerary['ticket_fare']}}
                                    <small class="unit-price-small ">{{ trans('vexe.money_ticket')}}</small>
                                    /{{ trans('vexe.ticket')}}
                                </h6>
                                <p>
                                    <a id="a-12062017-00701700 "
                                       class="ticket-ac-btn btn-vxr-lg btn pull-right w100 hasSeat closed a- online-button "
                            ...
                            <div id="main-infor " class="booking-expand ">
                                <div class="row " style="margin-bottom: -10px;">
                                    <div class="col-md-12 ">
                                        <div class=" bg-primary ">
                                            ...
                                            <div class="hidden-xs hidden-sm col-md-4 text-inf ">{{ trans('vexe.passenger_info')}}
                                                <span class="btn btn-close-road "><img
                                                            src="../images/vexe/btn-close.png " alt=" "
                                                            class="online-button"></span></div>
                                        </div>
                                    </div>
                                </div>
                                <!--row-->
                                    ...
                                    <div class="row " style="margin-bottom: -55px;">
                                        <div class="col-md-7 col-md-offset-0 col-xs-10 col-xs-offset-1 hidden-xs ">
                                            <div class="table-info ">
                                                ...
                                                <ul class="ul-table ">
                                                    <li><span class="span-text-2 ">{{ trans('vexe.itinerary')}}
                                                            :</span><b
                                                                class="pull-right ">{{ $list->itinerary['departPlace'] }}
                                                            → {{ $list->itinerary['destination']}} </b></li>
                                                    <input type="hidden" name="itinerary_id" value="{{ $list->id }}">
                                                    <li><span class="span-text-2 ">{{ trans('vexe.date_start')}}:</span><b
                                                                class="pull-right ">{{ $date_start }} </b></li>
                                                    <li><span class="span-text-2 ">{{ trans('vexe.time_start')}}:</span><b
                                                                class="pull-right ">{{ $list->time_start}} </b></li>
                                                    <input type="hidden" value="{{ $date_start }}" name="date_start">
                                                    <input type="hidden" value="{{  $list->time_start }}"
                                                           name="time_start">
                                                    <input type="hidden" value="{{  $list->time_back }}"
                                                           name="time_back">
                                                    <input type="hidden" value="{{  $list->date_back }}"
                                                           name="date_back">

                                                    <li><span class="span-text-2 ">{{ trans('vexe.departPlace_address')}}
                                                            :</span><b
                                                                class="pull-right ">{{ $list->itinerary['departPlace'] }} </b>
                                                    </li>
                                                    <li><span class="span-text-2 ">{{ trans('vexe.destination_address')}}
                                                            :</span><b
                                                                class="pull-right ">{{ $list->itinerary['destination']}}</b>
                                                    </li>
                                        ...
                                        <div class="col-xs-10 col-xs-offset-1 col-md-4 col-md-offset-0 customer-info-col "
                                             style="margin-left: 5%">
                                            ...
                                            <div class="form-group CustomerFullName ">
                                                <div class="col-md-12 col-sm-12 col-xs-12 pl0 pr0 ">
                                                    <label class="col-md-12 pl0 pr0 col-sm-3 control-label text-left user-control-label">{{ trans('vexe.name_passenger')}}
                                                        :</label>
                                                    <input id="name" name="name" type="text "
                                                           class="form-control input-vxr " value=""
                                                           placeholder="{{ trans('vexe.name_passenger')}}">
                                                </div>
                                            </div>
                                            <div class="col-md-12 col-sm-12 pl0 pr0 ">
                                                <label class="col-md-8 pl0 pr0 control-label text-left user-control-label">{{ trans('vexe.phone')}}
                                                    :</label>
                                            ...
                                            <div class="col-md-12 col-sm-12 pl0 pr0 ">
                                                <label class="col-md-8 pl0 pr0 control-label text-left user-control-label">{{ trans('vexe.email')}}
                                                    :</label>
                                                <input id="email" name="email" type="text "
                                                       class="form-control input-vxr " value="" placeholder="Email ">
                                            </div>

                                            <div class="col-md-12 col-sm-12 pl0 pr0">
                                                <label class="col-md-8 pl0 pr0 control-label text-left user-control-label">{{ trans('vexe.number_of_tickets')}}
                                                    :</label>
                                    ...
                                    <div class="row ">
                                        <div class="price-col ">
                                            <div class="col-md-4 col-md-offset-0 col-xs-5 col-xs-offset-1 ">
                                                ...
                                                <div id="single" data-price='{{ $list->itinerary['ticket_fare']}} '><b
                                                            class="b-text">{{ $list->itinerary['ticket_fare']}} </b>
                                                </div>
                                            </div>
                                            <input type="hidden" name="price_one"
                                                   value="{{ $list->itinerary['ticket_fare']}}">
                                            <div class="col-md-4 col-md-offset-0 col-xs-5 col-xs-offset-0 ">
                                                ...
                                                <div class="col-md-6 col-xs-12 ">
                                                    ...
                                                    <div class="pull-right ">
                                                        ...
                                                        <h4 class="seat-template-total-fare h4-text "
                                                            id="sum-price">{{ $list->itinerary['ticket_fare']}}</h4>
                                                        <small class="unit-price-small ">{{ trans('vexe.money_ticket')}}</small>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row ">
                                    <div class="col-md-12 col-xs-12 ">
                                        ...
                                        <h6 class="text-wblue thin200 pull-right pr5 ">{{ trans('vexe.question_contact')}}
                                            : <b><a class="hotline-link "
                                                    href="tel:{{ $data_configView['hot-line'] }} ">{{ $data_configView['hot-line'] }}</a></b>
                                        </h6>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <div class="nhaxe clearfix">
                                                <p class="p-text">{{ trans('vexe.car_cpm')}}: <b id="company_name"></b>
                                                </p>
                                                <p class="check-input-route ">
                                                    <span class="span-tt ">{{ trans('vexe.itinerary')}}:</span><b
                                                            id="itinerary_name"></b>
                                                    <input class="rating-input-item" data-val="true"
                                                           data-val-number="The field RouteId must be a number."
                                                           id="RouteId" name="RouteId" type="hidden" value="8087">
                                                </p>
                                            </div>
                                            <div class="form-nhaxe clearfix">
                                                <div class="check-input-date">
                                                    <span class="fa fa-calendar input-icon hidden-sm"></span>
                                                    <input id="startDate" name="DateOfJourney"
                                                           class="departDate txt rating-input-item hasDatepicker"
                                                           type="text"
                                                           placeholder="{{ trans('vexe.get_date_start')}} *">
                                                ...
                                                <div class="check-input-name">
                                                    ...
                                                    <input id="firstName" name="FirstName" class="txt rating-input-item"
                                                           type="text"
                                                           placeholder="{{ trans('vexe.name_passenger')}} *">
                                                    <span class="alert-no"></span>
                                                    <span class="alert-yes"></span>
                                                ...
                                                <div class="check-input-email">
                                                    ...
                                                    <input id="email_rating" name="Email" class="txt rating-input-item"
                                                           type="text" placeholder="{{ trans('vexe.email')}}: *">
                                                    <span class="alert-no"></span>
                                                    <span class="alert-yes"></span>
                                                </div>
                                                <div class="clearfix"></div>
                                                ...
                                                <div class="check-input-cmt">
                                                    ...
                                                    <textarea id="comment" class="rating-input-item" name="Comment"
                                                              placeholder="{{ trans('placeholder_notable')}}"></textarea>
                                                    <span class="alert-no"></span>
                                                    <span class="alert-yes"></span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <h6 class="uppercase top-padd text-center">
                                                <img class="ico-1" src="../images/vexe/pop-ico-danhgia.png" alt=""><b>Đánh
                                                    giá:
                                                </b></h6>
                                            <div class="alert-text text-center">
                                                ( {{ trans('vexe.plesase_click')}} <img
                                                        src="../images/vexe/pop-star-silver.png"
                                                        alt=""> {{ trans('to_notable')}})
                                            </div>
                                            <div class="pop-option-rate rate-chuyendi">
                                                ...
                                                <div class="rate_row" id="overAllRating">
                                                    ...
                                                    <input type="hidden" id="overAllRatingPoint"
                                                           name="overAllRatingPoint" class="get_star" value="0">
                                                </div>
                                            ...
                                            <div class="pop-point-rate pop-option-rate rate-chuyendi">
                                                ...
                                                <div class="rate_row" id="qualityRating">
                                                    ...
                                                    <span class="rate_star" data-value="4"></span>
                                                    <!-- <span class="rate_star" data-value="5"></span> -->
                                                    <input type="hidden" id="qualityRatingPoint"
                                                           name="qualityRatingPoint" class="get_star" value="0">
                                                </div>
                                            ...
                                            <div class="pop-option-rate">
                                                ...
                                                <div class="rate_row" id="inTimeRating">
                                                    ...
                                                    <span class="rate_star" data-value="4"></span>
                                                    <!-- <span class="rate_star" data-value="5"></span> -->
                                                    <input type="hidden" id="inTimeRatingPoint" name="inTimeRatingPoint"
                                                           class="get_star" value="0">
                                                </div>
                                            ...
                                            <div class="pop-option-rate">
                                                <span class="alert-yes"></span>
                                                <span class="alert-no"></span>
                                                <p><span class="pull-left">{{ trans('vexe.service_attitude')}}:</span>
                                                </p>
                                                ...
                                                <div class="rate_row" id="serviceRating">
                                                    ...
                                                    <span class="rate_star" data-value="4"></span>
                                                    <!-- <span class="rate_star" data-value="5"></span> -->
                                                    <input type="hidden" id="serviceRatingPoint"
                                                           name="serviceRatingPoint" class="get_star" value="0">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-xs-12">
                                                <div class="pop-ckb-confirm ">
                                                    <input class="pop-ckb CheckBoxClass pull-left" id="condition"
                                                           type="checkbox">
                                                    <label id="Label1" for="condition"
                                                           class="CheckBoxLabelClass pull-left">&nbsp;</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2 col-md-offset-5 col-xs-12">
                                                <a class="btn-danhgia uppercase" href="#"
                                                   id="send_rating">{{ trans('vexe.send_notable')}}</a>
