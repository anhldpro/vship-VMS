...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-md">
                ...
                <div class="top-menu">
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <img alt="" class="img-circle" src="{{url('images/avatar.png')}}" />
                        ...
                        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                           ...
                           {{--  <li class="nav-item start">
                                <a href="" class="nav-link nav-toggle">
                                    <i class="icon-home"></i>
                                    <span class="title">{{trans('admin.admin_dashboard')}}</span>
                                </a>
                            </li> --}}
                            
                        
                            <li class="heading">
                                <h3 class="uppercase">{{trans('admin.admin_func')}}</h3>
                            </li>
                           <!-- START KHÓA HỌC -->
                            <li class="nav-item {{ Request::is('news*') ? 'active open' : '' }}  ">
                                <a href="{{ route('admin.news.index') }}" class="nav-link nav-toggle">
                                    <i class="fa fa-newspaper-o "></i>
                                    <span class="title">{{trans('admin.admin_new')}}</span>
                                </a>
                            </li> 

                          <li class="nav-item {{ Request::is('BookTicket*') ? 'active open' : '' }}">
                                <a href="{{ route('admin.listBookTicket.index') }}" class="nav-link nav-toggle">
                                    <i class="fa fa-info "></i>
                                    <span class="title">{{trans('admin.admin_ticket')}}</span>
                                </a>
                            </li>


                            <li class="nav-item ">
                                <a href="{{ route('admin.car.index') }}"" class="nav-link nav-toggle">
                                    <i class="fa fa-bus"></i>
                            ...
                            <li class="nav-item ">
                                <a href="{{ route('admin.station.index') }}"" class="nav-link nav-toggle">
                                    <i class="fa fa-map-marker"></i>
                                    <span class="title">Bến Xe</span>
                                </a>
                            </li>

                            <li class="nav-item ">
                                <a href="{{ route('admin.place.index') }}"" class="nav-link nav-toggle">
                                    <i class="fa fa-map-marker"></i>
                            ...
                            <li class="nav-item ">
                                <a href="{{ route('admin.itinerary.index') }}" class="nav-link nav-toggle">
                                    <i class="fa fa-money"></i>
                                    <span class="title">Tuyến Đường Và Giá Vé</span>
                                </a>
                            </li>
                            
                            <li class="nav-item ">
                                <a href="{{ route('admin.ticketInfo.index') }}" class="nav-link nav-toggle">
                                    <i class="fa fa-road"></i>
                                    <span class="title">Tuyến Đường Và Giờ Xuất Phát</span>
                                </a>
                            </li>
                            <li class="nav-item ">
                            ...
                            <li class="nav-item" id="giaodien">
                                <a href="javascript:;" class="nav-link nav-toggle link-frame">
                                    <i class="fa fa-desktop " aria-hidden="true"></i>
                                    <span class="title">Giao diện</span>
                                    <span class="caret link-frame"></span>
                                </a>

                                <ul class="sub-menu" id="menu-giaodien">
                                    <li class="nav-item ">
                                        <a href="{{ route('admin.imgBlade.index')}}" class="nav-link ">
                                        <i class="fa fa-picture-o  " aria-hidden="true"></i>
                                            <span class="title">Hình ảnh</span>
                                        </a>
                                    </li>
                                    <li class="nav-item  ">
                                        <a href="{{ route('admin.viewBlade.index')}}" class="nav-link ">
        ...
        <div class="page-footer">
           <!--  <div class="page-footer-inner"> 2016 &copy; Zent Group. -->
            </div>
