...
<head>
    ...
    <!-- Data table CSS -->
    <link href="{{url('bower_components/datatables/media/css/jquery.dataTables.min.css')}}" rel="stylesheet" type="text/css"/>

    <link href="{{url('bower_components/jquery-toast-plugin/dist/jquery.toast.min.css')}}" rel="stylesheet" type="text/css">
                            ...
                            <ul class="pa-20">
                                ...
                                <li class="col-md-6 col-xs-12 preview-carousel">
                                    ...
                                    <div class="product-carousel owl-carousel owl-theme text-center">
                                        <a href="#">
                                            <img src="{{url('dist/img/chair.jpg')}}" alt="chair">
                                            <span>Circle chair</span>
                                        </a>
                                        <a href="#">
                                            <img src="{{url('dist/img/chair2.jpg')}}" alt="chair">
                                            <span>square chair</span>
                                        </a>
                                        <a href="#">
                                            <img src="{{url('dist/img/chair3.jpg')}}" alt="chair">
                                            <span>semi circle chair</span>
                                        </a>
                                        <a href="#">
                                            <img src="{{url('dist/img/chair4.jpg')}}" alt="chair">
                        ...
                        <li>
                            <div class="streamline message-nicescroll-bar">
                                ...
                                <div class="sl-item">
                                    <a href="javascript:void(0)">
                                        <div class="sl-avatar">
                                            <img class="img-responsive" src="{{url('dist/img/avatar.jpg')}}" alt="avatar"/>
                                        </div>
                                        <div class="sl-content">
                                            ...
                                            <ul class="chat-list-wrap">
                                                <li class="chat-list">
                                                    <div class="chat-body">
                                                        <a  href="javascript:void(0)">
                                                            <div class="chat-data">
                                                                <img class="user-img img-circle"  src="{{url('dist/img/user.png')}}" alt="user"/>
                                                                <div class="user-data">
                                                        ...
                                                        <a  href="javascript:void(0)">
                                                            <div class="chat-data">
                                                                <img class="user-img img-circle"  src="{{url('dist/img/user1.png')}}" alt="user"/>
                                                                <div class="user-data">
                                                        ...
                                                        <a  href="javascript:void(0)">
                                                            <div class="chat-data">
                                                                <img class="user-img img-circle"  src="{{url('dist/img/user2.png')}}" alt="user"/>
                                                                <div class="user-data">
                                                        ...
                                                        <a  href="javascript:void(0)">
                                                            <div class="chat-data">
                                                                <img class="user-img img-circle"  src="{{url('dist/img/user3.png')}}" alt="user"/>
                                                                <div class="user-data">
                                                        ...
                                                        <a  href="javascript:void(0)">
                                                            <div class="chat-data">
                                                                <img class="user-img img-circle"  src="{{url('dist/img/user4.png')}}" alt="user"/>
                                                                <div class="user-data">
                                                    ...
                                                    <ul class="nicescroll-bar pt-20">
                                                        <li class="friend">
                                                            <div class="friend-msg-wrap">
                                                                <img class="user-img img-circle block pull-left"  src="{{url('dist/img/user.png')}}" alt="user"/>
                                ...
                                <div class="set-height-wrap">
                                    <div class="streamline message-box nicescroll-bar">
                                        <a href="javascript:void(0)">
                                            <div class="sl-item unread-message">
                                                <div class="sl-avatar avatar avatar-sm avatar-circle">
                                                    <img class="img-responsive img-circle" src="{{url('dist/img/user.png')}}" alt="avatar"/>
                                                </div>
                                                <div class="sl-content">
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="sl-item">
                                                <div class="sl-avatar avatar avatar-sm avatar-circle">
                                                    <img class="img-responsive img-circle" src="{{url('dist/img/user1.png')}}" alt="avatar"/>
                                                </div>
                                                <div class="sl-content">
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="sl-item">
                                                <div class="sl-avatar avatar avatar-sm avatar-circle">
                                                    <img class="img-responsive img-circle" src="{{url('dist/img/user2.png')}}" alt="avatar"/>
                                                </div>
                                                <div class="sl-content">
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="sl-item unread-message">
                                                <div class="sl-avatar avatar avatar-sm avatar-circle">
                                                    <img class="img-responsive img-circle" src="{{url('dist/img/user3.png')}}" alt="avatar"/>
                                                </div>
                                                <div class="sl-content">
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="sl-item unread-message">
                                                <div class="sl-avatar avatar avatar-sm avatar-circle">
                                                    <img class="img-responsive img-circle" src="{{url('dist/img/user4.png')}}}" alt="avatar"/>
                                                </div>
                                                <div class="sl-content">
...
<script src="{{url('bower_components/simpleWeather/jquery.simpleWeather.min.js')}}"></script>
<script src="{{url('dist/js/simpleweather-data.js')}}"></script>

<!-- Progressbar Animation JavaScript -->
<script src="{{url('bower_components/waypoints/lib/jquery.waypoints.min.js')}}"></script>
<script src="{{url('bower_components/jquery.counterup/jquery.counterup.min.js')}}"></script>
...
<script src="{{url('bower_components/switchery/dist/switchery.min.js')}}"></script>
