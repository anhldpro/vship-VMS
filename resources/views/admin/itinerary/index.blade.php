...
<div class="portlet-title">
    <div class="caption uppercase">
        <i class="fa fa-book"></i> LỘ TRÌNH VÀ GIÁ VÉ </div>
...
<div class="portlet-body">
    <div class="table-scrollable" id="repalceTable">
...
<script>
 function alertDel(id){
  ...
  console.log(id);
  var path = "{{URL::asset('')}}admin/itinerary/" + id;
  console.log(path);
   ...
   $("#search").on('keyup', function() {
    // .delay(function(){
      var keyword = $("#search").val();
          $.ajax({
              type: "GET",
              url: "itinerary/search?keyword=" + keyword,
              cache: false,
...
$(document).ready(function(){
 ...
 <script>
     function addBlog() {
         window.location = "{{ route('admin.itinerary.create') }}"
     }
 </script>
