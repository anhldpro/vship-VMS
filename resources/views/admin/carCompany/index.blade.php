        ...
        <table class="table table-striped table-bordered table-hover" id="sample_1">
            ...
            <tbody>
                    ...
                    <td class="text-center"> 
                        <a href="{{route('admin.car.show',$list->id)}}" class="btn btn-outline btn-circle btn-sm blue">
                            <i class="fa fa-eye" aria-hidden="true"></i> {{trans('admin.admin_show')}} 
                        </a>
                        <a href="{{route('admin.car.edit',$list['id'])}}" class="btn btn-outline btn-circle green btn-sm purple">
...
$(document).ready(function(){
 ...
 <script>
     function addBlog() {
         window.location = "{{ route('admin.car.create') }}"
     }
 </script>
@endsection