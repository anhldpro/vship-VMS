...
<div class="portlet-title">
    <div class="caption uppercase">
        <i class="fa fa-book"></i> LỘ TRÌNH VÀ GIỜ XUẤT PHÁT </div>
</div>
<div class="row">
        ...
        <table class="table table-striped table-bordered table-hover" id="sample_1">
            <thead>
                <tr>
                  ...
                  <th style="text-align: center;">Thời Gian Xuất Phát</th>
            ...
            <tbody>
                      ...
                      <tr>
                        ...
                        <td style="text-align: center;">{{ $list->time_start  }}</td>
                  
                    <td class="text-center"> 
                        <a href="{{route('admin.ticketInfo.show',$list->id)}}" class="btn btn-outline btn-circle btn-sm blue">
                            <i class="fa fa-eye" aria-hidden="true"></i> {{trans('admin.admin_show')}} 
                        </a>
                        <a href="{{route('admin.ticketInfo.edit',$list['id'])}}" class="btn btn-outline btn-circle green btn-sm purple">
...
<script>
 function alertDel(id){
  ...
  console.log(id);
  var path = "{{URL::asset('')}}admin/ticket-info/" + id;
  console.log(path);
...
$(document).ready(function(){
 ...
 <script>
     function addBlog() {
         window.location = "{{ route('admin.ticketInfo.create') }}"
     }
 </script>
@endsection