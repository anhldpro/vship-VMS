...
class ImageRepository
{
    ...
    {
        $validator = Validator::make($form_data, ImageUpload::$rules, ImageUpload::$messages);
        if ($validator->fails()) {
    ...
    public function delete( $filename )
    {
        ...
        $sessionImage = ImageUpload::where('filename', 'like', $filename)->first();
